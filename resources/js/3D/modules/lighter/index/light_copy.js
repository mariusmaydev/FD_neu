...
export default function light(scene){
    ...
    let atmo = lights.new.AmbientLight(0xffffff, 2);
        atmo.bind();
    ...
    let directional1 = lights.new.DirectionalLight( 0xffe6cd, 5 );
    ...
    let directional2 = lights.new.DirectionalLight( 0xffe6cd, 5 );
