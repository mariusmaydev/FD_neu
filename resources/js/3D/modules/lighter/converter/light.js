...
export default function light(scene){
    ...
    let directional1 = lights.new.DirectionalLight( 0xffe6cd, 3 );
        ...
        directional1.shadow.bias = -0.000015;
        ...
        directional1.shadow.camera.near =0.015
        directional1.shadow.camera.far = 100
        directional1.shadow.camera.left = -1; // or whatever value works for the scale of your scene
        directional1.shadow.camera.right = 1;
        directional1.shadow.camera.top = 2;
        directional1.shadow.camera.bottom = -0.01;
    ...
    let directional2 = lights.new.DirectionalLight( 0xffe6cd, 3 );
        ...
        directional2.shadow.bias = -0.000015;
